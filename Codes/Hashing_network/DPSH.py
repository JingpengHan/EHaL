...
class DPSH(object):
    ...
    def train(self, train_loader, train_labels, num_train):
        ...
        for epoch in range(self.args.n_epochs):
            ...
            print('Epoch: %3d/%3d\tTraining_loss: %3.5f' %
    ...
    def test(self, database_loader, test_loader, database_labels, test_labels,
        ...
        top10map_ = CalcTopMap(qB, dB, test_labels.numpy(), database_labels.numpy(),10)
        print('Original-original_MAP: %3.5f' % (map_))
        print('Original-original_top10MAP: %3.5f' % (top10map_))